...
def create_mgmt_interface(vserver_name: str, ip_address: str, ip_netmask) -> None:
    """Creates an Cluster-scoped IP Interface"""
    ...
    try:
        ip_interface.post()
        print("Ip Management Interface %s created successfully" % ip_interface.ip.address)
    except NetAppRestError as err:
        print("Error: IP Management Interface was not created: %s" % err)
    return
...
if __name__ == "__main__":
    ...
    create_mgmt_interface(args.vserver_name, args.ip_address, args.ip_netmask)
