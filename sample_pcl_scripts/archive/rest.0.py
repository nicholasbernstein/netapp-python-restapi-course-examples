...
usage: python3.7 rest.py [-h] -c CLUSTER -v VOLUME_NAME -vn VSERVER_NAME -a AGGR_NAME
...
def create_svm_pycl(vserver_name: str, aggr_name: str) -> None:
...
if __name__ == "__main__":
    ...
    create_aggregate_pycl(args.aggr_name, args.node_name, args.disk_count)
    create_svm_pycl (args.vserver_name, args.aggr_name)
