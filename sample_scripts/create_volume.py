...
#
# Purpose: Script to create a new Flexvol using ONBOX REST API's.
#
#
# Usage:   %> create_volume.py <args>
#
...
def make_volume(vol_name,svm_name,vol_size,aggr_name):
...
if __name__ == "__main__":
    ...
    make_volume(vol_name,svm_name,vol_size,aggr_name)
